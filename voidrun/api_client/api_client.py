...
from voidrun.api_client.api_response import ApiResponse, T as ApiResponseT
import voidrun.api_client.models
from voidrun.api_client import rest
from voidrun.api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(voidrun.api_client.models, klass)
