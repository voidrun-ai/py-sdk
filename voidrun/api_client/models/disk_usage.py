...
class DiskUsage(BaseModel):
    ...
    human_readable: Optional[StrictStr] = Field(default=None, alias="humanReadable", json_schema_extra={"examples": ["1.5 GB"]})
    __properties: ClassVar[List[str]] = ["path", "size", "humanReadable"]
