...
class GetPTYBuffer200ResponseAllOfData(BaseModel):
    """
    GetPTYBuffer200ResponseAllOfData
    """ # noqa: E501
    output: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Command output text"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPTYBuffer200ResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPTYBuffer200ResponseAllOfData from a dict"""
        if obj is None:
            return None
