...
class StartWatch200Response(BaseModel):
    """
    StartWatch200Response
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["success"]})
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["watch started"]})
    data: Optional[StartWatch200ResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartWatch200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartWatch200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": StartWatch200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
