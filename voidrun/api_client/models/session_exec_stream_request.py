...
class SessionExecStreamRequest(BaseModel):
    ...
    """ # noqa: E501
    session_id: StrictStr = Field(alias="sessionId", json_schema_extra={"examples": ["sess-1a2b3c4d5e6f7788"]})
    command: StrictStr = Field(json_schema_extra={"examples": ["tail -f /var/log/syslog"]})
