...
class StartWatchRequest(BaseModel):
    ...
    StartWatchRequest
    """ # noqa: E501
    path: StrictStr = Field(json_schema_extra={"examples": ["/app/logs"]})
    recursive: Optional[StrictBool] = False
    ignore_hidden: Optional[StrictBool] = Field(default=True, description="Skip directories that start with '.'", alias="ignoreHidden")
    __properties: ClassVar[List[str]] = ["path", "recursive", "ignoreHidden"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartWatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartWatchRequest from a dict"""
        if obj is None:
            return None
