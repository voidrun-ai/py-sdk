...
class Sandbox(BaseModel):
    ...
    mem: Optional[StrictInt] = None
    status: Optional[StrictStr] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    created_by: Optional[StrictStr] = Field(default=None, alias="createdBy")
    org_id: Optional[StrictStr] = Field(default=None, alias="orgId")
    env_vars: Optional[Dict[str, StrictStr]] = Field(default=None, description="Environment variables set on the sandbox", alias="envVars")
    __properties: ClassVar[List[str]] = ["id", "name", "imageId", "ip", "cpu", "mem", "status", "createdAt", "createdBy", "orgId", "envVars"]
