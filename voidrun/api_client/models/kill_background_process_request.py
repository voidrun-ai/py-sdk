...
class KillBackgroundProcessRequest(BaseModel):
    """
    KillBackgroundProcessRequest
    """ # noqa: E501
    pid: StrictInt = Field(json_schema_extra={"examples": [1234]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KillBackgroundProcessRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KillBackgroundProcessRequest from a dict"""
        if obj is None:
            return None
