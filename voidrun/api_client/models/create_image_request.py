...
class CreateImageRequest(BaseModel):
    ...
    CreateImageRequest
    """ # noqa: E501
    name: StrictStr = Field(json_schema_extra={"examples": ["custom-image"]})
    version: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["1.0"]})
    path: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["/var/lib/images/custom.img"]})
