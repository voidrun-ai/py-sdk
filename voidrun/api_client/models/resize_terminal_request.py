...
class ResizeTerminalRequest(BaseModel):
    ...
    """ # noqa: E501
    cols: Annotated[int, Field(le=500, strict=True, ge=1)] = Field(json_schema_extra={"examples": [100]})
    rows: Annotated[int, Field(le=200, strict=True, ge=1)] = Field(json_schema_extra={"examples": [40]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResizeTerminalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResizeTerminalRequest from a dict"""
        if obj is None:
            return None
