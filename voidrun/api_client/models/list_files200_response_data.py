...
class ListFiles200ResponseData(BaseModel):
    """
    ListFiles200ResponseData
    """ # noqa: E501
    success: Optional[StrictBool] = None
    files: Optional[List[FileInfo]] = None
    __properties: ClassVar[List[str]] = ["success", "files"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListFiles200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListFiles200ResponseData from a dict"""
        if obj is None:
            return None
