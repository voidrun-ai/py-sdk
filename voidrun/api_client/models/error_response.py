...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Invalid request"]})
    details: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Additional error details"]})
