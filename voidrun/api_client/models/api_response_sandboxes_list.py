...
class ApiResponseSandboxesList(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiResponseSandboxesList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiResponseSandboxesList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "meta": ApiResponseSandboxesListMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
