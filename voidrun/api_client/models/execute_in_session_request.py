...
class ExecuteInSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    command: StrictStr = Field(json_schema_extra={"examples": ["top -b -n 1"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExecuteInSessionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExecuteInSessionRequest from a dict"""
        if obj is None:
            return None
