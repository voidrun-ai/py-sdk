...
class StartWatch200ResponseData(BaseModel):
    """
    StartWatch200ResponseData
    """ # noqa: E501
    session_id: Optional[UUID] = Field(default=None, alias="sessionId", json_schema_extra={"examples": ["a1b2c3d4-e5f6-7890-abcd-ef1234567890"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartWatch200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartWatch200ResponseData from a dict"""
        if obj is None:
            return None
