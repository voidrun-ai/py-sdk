...
class CreateSandbox201Response(BaseModel):
    """
    CreateSandbox201Response
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["success"]})
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Sandbox created"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSandbox201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSandbox201Response from a dict"""
        if obj is None:
            return None
