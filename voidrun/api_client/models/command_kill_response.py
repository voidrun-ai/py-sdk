...
class CommandKillResponse(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Process killed"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommandKillResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommandKillResponse from a dict"""
        if obj is None:
            return None
