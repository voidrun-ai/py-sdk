...
class ApiResponseSandbox(BaseModel):
    """
    ApiResponseSandbox
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [True]})
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Sandbox details fetched successfully"]})
    data: Optional[Sandbox] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiResponseSandbox from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiResponseSandbox from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": Sandbox.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
