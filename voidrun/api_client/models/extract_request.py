...
class ExtractRequest(BaseModel):
    ...
    ExtractRequest
    """ # noqa: E501
    archive: StrictStr = Field(json_schema_extra={"examples": ["/backup.tar.gz"]})
    dest: StrictStr = Field(json_schema_extra={"examples": ["/restore"]})
    __properties: ClassVar[List[str]] = ["archive", "dest"]
