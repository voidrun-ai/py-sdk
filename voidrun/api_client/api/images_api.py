...
class ImagesApi:
    ...
    def get_image_by_name(
        ...
        _param = self._get_image_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_image_by_name_with_http_info(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_image_by_name_without_preload_content(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_image_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/images/name/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
